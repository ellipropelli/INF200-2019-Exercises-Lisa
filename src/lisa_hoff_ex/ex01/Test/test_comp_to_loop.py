...
def test_zero_input yields_length_zero():
    assert len(suares_by_loop(0)) == 0


def test_zero_input yields_length_one():
    assert len(suares_by_loop(1)) == 1


def test_corrct_number_of_outputs():
